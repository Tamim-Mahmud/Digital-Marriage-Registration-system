...
$extension2 = substr($wimg,strlen($wimg)-4,strlen($wimg));// allowed 

$nimg=$_FILES['nikahimage']['name'];
$extension3 = substr($nimg,strlen($nimg)-4,strlen($nimg));
...
{
echo "<script>alert('Nikahnama image has Invalid format. Only jpg / jpeg/ png /gif format allowed');</script>";
}
else
{
//rename images
...
$nikahimg=md5($nimg).time().$extension3;

move_uploaded_file($_FILES["husimage"]["tmp_name"],"images/".$husimg);
     move_uploaded_file($_FILES["wifeimage"]["tmp_name"],"images/".$wifeimg);
        move_uploaded_file($_FILES["nikahimage"]["tmp_name"],"images/".$nikahimg);

$ret="select HusbandNidno,WifeNidNo from tblregistration where HusbandNidno=:hnidno || WifeNidNo=:wnidno";
 $query= $dbh -> prepare($ret);
$query->bindParam(':hnidno',$hnidno,PDO::PARAM_STR);
$query->bindParam(':wnidno',$wnidno,PDO::PARAM_STR);
...
$sql="insert into tblregistration(RegistrationNumber,UserID,DateofMarriage,HusbandName,HusImage,HusbandReligion,Husbanddob,HusbandSBM,HusbandAdd,HusbandZipcode,Husbandcity,HusbandNidno,HusbandMobno,WifeName,WifeImage,WifeReligion,Wifedob,WifeSBM,WifeAdd,WifeZipcode,Wifecity,WifeNidNo,WifeMobNo,WitnessNamefirst,WitnessAddressFirst,WitnessNamesec,WitnessAddresssec,WitnessNamethird,WitnessAddressthird,nikahnama)values(:regnumber,:uid,:dom,:nofhusband,:husimg,:hreligion,:hdob,:hsbmarriage,:haddress,:hzipcode,:hcity,:hnidno,:hmobno,:nofwife,:wifeimg,:wreligion,:wdob,:wsbmarriage,:waddress,:wzipcode,:wcity,:wnidno,:wmobno,:witnessnamef,:waddressfirst,:witnessnames,:waddresssec,:witnessnamet,:waddressthird:nikahimg)";
...
$query->bindParam(':hcity',$hcity,PDO::PARAM_STR);
$query->bindParam(':hnidno',$hnidno,PDO::PARAM_STR);
$query->bindParam(':hmobno',$hmobno,PDO::PARAM_STR);
...
$query->bindParam(':wcity',$wcity,PDO::PARAM_STR);
$query->bindParam(':wnidno',$wnidno,PDO::PARAM_STR);
$query->bindParam(':wmobno',$wmobno,PDO::PARAM_STR);
...
$query->bindParam(':nikahimg',$nikahimg,PDO::PARAM_STR);
...
echo "<script>alert('Nid Number is  already exist. Please try again');</script>";
          ...
          <!-- wd-200 -->
             ...
             <div class="row mg-t-20">
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" name="hcity" value=""  class="form-control" required='true'>
                </div>
              </div>
               <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Enter Nid Number: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                 <input type="text" name="hnidno" value="" required="true" class="form-control" maxlength="12">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Enter Mobile Number: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                 <input type="text" name="hmobno" value="" required="true" class="form-control" maxlength="12">
                </div>
              </div>
              ...
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">City: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" name="wcity" value=""  class="form-control" required='true'>
                </div>
              </div>
               <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Enter Nid Number: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                 <input type="text" name="wnidno" value="" required="true" class="form-control" maxlength="12">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Enter Mobile Number: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                 <input type="text" name="wmobno" value="" required="true" class="form-control" maxlength="12">
                </div>
              </div>
              ...
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">NikahNama: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="file" name="nikahimage" value="" class="form-control" required='true'>
                </div>
              </div>
